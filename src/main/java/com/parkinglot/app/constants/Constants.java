...
public class Constants {
    ...
    public static final String UNKNOWN_PARKING_LOT_IMPLEMENTATION = "Unknown Parking lot implementation.";
    public static final String UNKNOWN_PARKING_SPOT_IMPLEMENTATION = "Unknown Parking Spot implementation";
